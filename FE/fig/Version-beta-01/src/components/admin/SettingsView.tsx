        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0054a6] focus:border-transparent"
            />
          </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-11 pr-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0054a6] focus:border-transparent"
              />
            </div>
          </div>
        </div>
        ...
        <div className="space-y-3">
          <label className="flex items-center gap-3 p-3 hover:bg-gray-50 rounded-lg cursor-pointer transition">
            <input
              ...
              className="w-5 h-5 text-[#0054a6] border-gray-300 rounded focus:ring-[#0054a6]"
            />
