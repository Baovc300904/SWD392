  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
      {topics.map((topic) => (
        <div
          key={topic.id}
          className="bg-white rounded-xl border border-gray-200 p-6 hover:shadow-lg hover:border-[#F27125]/30 transition flex flex-col"
        >
          {/* Header */}
          <div className="mb-5">
            <h3 className="text-lg font-bold text-gray-900 mb-4 leading-snug">{topic.title}</h3>
            <div className="flex items-center gap-3">
              ...
              />
              <div>
                <div className="text-xs text-gray-500 font-medium">Lecturer</div>
          ...
          <div className="grid grid-cols-2 gap-3 pt-5 border-t border-gray-200">
            <button className="flex items-center justify-center gap-2 px-4 py-3 bg-white border-2 border-red-500 text-red-600 rounded-lg font-semibold hover:bg-red-50 transition shadow-sm hover:shadow">
              <X className="w-5 h-5" />
              Reject
            </button>
            <button className="flex items-center justify-center gap-2 px-4 py-3 bg-[#F27125] text-white rounded-lg font-semibold hover:bg-[#d96420] transition shadow-md hover:shadow-lg">
