...
interface LecturerSidebarProps {
  activeView: 'dashboard' | 'groups' | 'approvals' | 'syllabus';
  onViewChange: (view: 'dashboard' | 'groups' | 'approvals' | 'syllabus') => void;
  onLogout: () => void;
}

export function LecturerSidebar({ activeView, onViewChange, onLogout }: LecturerSidebarProps) {
  const menuItems = [
    {
